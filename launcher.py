...
commands_continualworld_ppo = [
    ...
    # MIG 2 (7-13)
    ['MIG-2d5b6364-fc42-587b-97c6-ee316a82e2f3', 'python train_continualworld.py baseline --env_config_path ./env_configs/continualworld_10.json --max_steps 2_000_000 --seed 86 --disable_task_label_input'],
    ['MIG-4590f80d-be70-58e4-af75-eeb950255d4a', 'python train_continualworld.py baseline --env_config_path ./env_configs/continualworld_10.json --max_steps 2_000_000 --seed 87 --disable_task_label_input'],
    ['MIG-e76a2a9b-9867-5f8a-b145-d857cd5ed8e2', 'python train_continualworld.py baseline --env_config_path ./env_configs/continualworld_10.json --max_steps 2_000_000 --seed 88 --disable_task_label_input'],
    ['MIG-2593b912-5975-58e9-bc3d-495311cee807', 'python train_continualworld.py baseline --env_config_path ./env_configs/continualworld_10.json --max_steps 2_000_000 --seed 89 --disable_task_label_input'],
    ['MIG-51069529-f343-59c6-bac7-a75648296e7b', 'python train_continualworld.py baseline --env_config_path ./env_configs/continualworld_10.json --max_steps 2_000_000 --seed 90 --disable_task_label_input'],
    ['MIG-187573d8-7df7-5e5f-87b2-c8b8f73c54e7', 'python train_continualworld.py baseline --env_config_path ./env_configs/continualworld_10.json --max_steps 2_000_000 --seed 91 --disable_task_label_input'],
    ['MIG-3045e3dd-28b6-5ee8-96b5-60a085c9fcf1', 'python train_continualworld.py baseline --env_config_path ./env_configs/continualworld_10.json --max_steps 2_000_000 --seed 92 --disable_task_label_input']
]
...
def make_ctgraph_single_task_expert_commands():
    commands = []
...
commands_ctgraph_single_task_experts = [
    # MIG 1 (7-13)
    ['MIG-c3ce33ce-ced8-5961-bb87-2b40eb100277', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task1 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task1.json'],
    ['MIG-280489c4-1d98-5b07-b4f6-2fc85fc874fa', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task6 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task6.json'],
    ['MIG-c432df19-0894-5232-ac1c-9a3440fc267e', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task17 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task17.json'],
    ['MIG-e8f61a95-352a-56cc-b95d-0c35fc14e8bf', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task39 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task39.json'],
    ['MIG-35ecef79-db2e-590b-9e8c-2c07c787008e', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task82 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task82.json'],
    ['MIG-76cd8dd7-7703-5581-8ac5-a7ee81a402a0', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task169 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task169.json'],
    ['MIG-b35e1a68-f7a4-5ef9-b34a-1abf6d1f8c2e', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task342 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task342.json'],

    ['MIG-c3ce33ce-ced8-5961-bb87-2b40eb100277', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task4095 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task4095.json'],
    ['MIG-280489c4-1d98-5b07-b4f6-2fc85fc874fa', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task4102 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task4102.json'],
    ['MIG-c432df19-0894-5232-ac1c-9a3440fc267e', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task4117 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task4117.json'],
    ['MIG-e8f61a95-352a-56cc-b95d-0c35fc14e8bf', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task4146 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task4146.json'],
    ['MIG-35ecef79-db2e-590b-9e8c-2c07c787008e', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task4205 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task4205.json'],
    ['MIG-76cd8dd7-7703-5581-8ac5-a7ee81a402a0', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task4322 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task4322.json'],
    ['MIG-b35e1a68-f7a4-5ef9-b34a-1abf6d1f8c2e', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task4557 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task4557.json'],

    # MIG 2 (7-13)
    ['MIG-2d5b6364-fc42-587b-97c6-ee316a82e2f3', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task8184 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task8184.json'],
    ['MIG-4590f80d-be70-58e4-af75-eeb950255d4a', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task8189 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task8189.json'],
    ['MIG-e76a2a9b-9867-5f8a-b145-d857cd5ed8e2', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task8198 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task8198.json'],
    ['MIG-2593b912-5975-58e9-bc3d-495311cee807', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task8216 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task8216.json'],
    ['MIG-51069529-f343-59c6-bac7-a75648296e7b', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task8253 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task8253.json'],
    ['MIG-187573d8-7df7-5e5f-87b2-c8b8f73c54e7', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task8327 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task8327.json'],
    ['MIG-3045e3dd-28b6-5ee8-96b5-60a085c9fcf1', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task8474 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task8474.json'],

    ['MIG-2d5b6364-fc42-587b-97c6-ee316a82e2f3', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task12278 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task12278.json'],
    ['MIG-4590f80d-be70-58e4-af75-eeb950255d4a', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task12284 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task12284.json'],
    ['MIG-e76a2a9b-9867-5f8a-b145-d857cd5ed8e2', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task12297 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task12297.json'],
    ['MIG-2593b912-5975-58e9-bc3d-495311cee807', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task12323 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task12323.json'],
    ['MIG-51069529-f343-59c6-bac7-a75648296e7b', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task12375 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task12375.json'],
    ['MIG-187573d8-7df7-5e5f-87b2-c8b8f73c54e7', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task12478 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task12478.json'],
    ['MIG-3045e3dd-28b6-5ee8-96b5-60a085c9fcf1', 'python train_ctgraph.py baseline --max_steps 51200 --seed 86 --exp_id task12684 --env_config_path ./env_configs/ct28/seed1_individual/meta_ctgraph_ct28_task12684.json']
]
...
if args.env == 'ctgraph_lc':
    ...
    commands = commands_ctgraph_single_task_experts
elif args.env == 'minigrid_ppo':
    commands = commands_minigrid_ppo
elif args.env == 'continualworld':
    commands = commands_continualworld
elif args.env == 'continualworld_ppo':
    cpmmands = commands_continualworld_ppo
elif args.env == 'minigrid_individual':
    commands = commands_minigrid_single_task_experts
else:
...
if args.env == 'minigrid_individual':
    processes = []
    for command in commands:
        command_path_header = path_header
        if len(command) > 2 and command[2]:
            command_path_header = os.path.join(path_header, command[2])
        print(f"{command[0]}, {command[1]} -p {command_path_header}")
        env['CUDA_VISIBLE_DEVICES'] = command[0]
        process = subprocess.Popen(shlex.split(command[1] + f' -p {command_path_header}'), env=env)
